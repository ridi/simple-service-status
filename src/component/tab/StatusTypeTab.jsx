...
import StatusTypeModal from '../modal/StatusTypeModal';
import Table from '../Table';
import Loading from '../Loading';
import Api from '../../common/api';

export default class StatusTypeTab extends BaseRefreshableTab {
  constructor(props) {
    super(props);
    ...
    this.columns = [
      ...
      { title: '값', key: 'value' },
      {
        title: '템플릿',
        isChildRow: true,
        display: row => (row.template ? <span dangerouslySetInnerHTML={{ __html: row.template }} /> : ''),
      },
    ];
  }
